                    ...
                    {dashboardData?.recentAppointments.length > 0 ? (dashboardData?.recentAppointments.map((appointment) => {
                        ...
                        return (
                            <div className="flex items-center px-6 py-3 gap-3 hover:bg-gray-100" key={appointment._id}>
                                <img className="rounded-full bg-indigo-50 w-10" src={appointment.docData.image} alt={appointment.docData.name} />
                        ...
                        <p className="text-gray-600 font-medium text-lg py-4 col-span-3 text-center">No appointments found</p>
                    )}
                </div>
            </div>
        </div>
